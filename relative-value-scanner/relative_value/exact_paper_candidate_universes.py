    ...
    if exact_scope_rows:
        lines.extend(
            [
                ...
                "",
                "| Universe | Status | BTC inventory | BTC relevant | Typed BTC formulas | BTC exact groups | BTC cross-venue groups | BTC ladders | BTC noisy | Fed inventory | Fed relevant | Typed Fed formulas | Fed exact groups | Fed cross-venue groups | Fed overlaps | Fed noisy | Missing meeting | Missing range | Not exact | Source basis | Date/deadline | FOMC event | Threshold/condition | Unresolved ambiguity |",
                "|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---|---|---|",
            ]
        )
            ...
            lines.append(
                ...
                + " | ".join(
                    [
                        ...
                        _md(btc_counts.get("btc_relevant_threshold_count", "")),
                        _md(btc_counts.get("typed_btc_formula_count", "")),
                        _md(btc_counts.get("exact_key_group_count", "")),
                        _md(btc_counts.get("exact_cross_venue_key_group_count", "")),
                        _md(btc_counts.get("threshold_ladder_count", "")),
                        _md(btc_counts.get("noisy_inventory_count", "")),
                        _md(fed_counts.get("fed_inventory_count", "")),
                        _md(fed_counts.get("fed_relevant_target_range_count", "")),
                        _md(fed_counts.get("typed_fed_formula_count", "")),
                        _md(fed_counts.get("exact_meeting_range_group_count", "")),
                        _md(fed_counts.get("exact_cross_venue_meeting_range_group_count", "")),
                        _md(fed_counts.get("overlapping_range_count", "")),
                        _md(fed_counts.get("noisy_inventory_count", "")),
