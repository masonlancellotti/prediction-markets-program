...
def _research_market(
    ...
    *,
    ...
    return {
        ...
        "contract_terms_url_or_text": instrument.get("contract_terms_url_or_text"),
        ...
        "yes_no_payout_terms": settlement.get("yes_no_payout_terms"),
        ...
        "market_data_timestamp": quote.get("market_data_timestamp") or quote.get("quote_timestamp"),
        "quote_timestamp": quote.get("quote_timestamp") or quote.get("market_data_timestamp"),
        ...
        "per_contract_fee": _number_or_none(settlement.get("per_contract_fee")),
        "regulatory_or_exchange_fees": _number_or_none(settlement.get("regulatory_or_exchange_fees")),
        "is_executable": False,
        "can_create_candidate_pair": False,
        "can_create_paper_candidate": False,
        "execution_allowed_in_project_now": False,
